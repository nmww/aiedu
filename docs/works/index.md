...
除了上面这些部署在公网上的应用，我在 **Gitee** 与 **GitHub** 上也维护了完整的开源仓库：核心 SDK、技能包、移动端与小程序工程、数据集与工具链。

- **Gitee** [@markets2022](https://gitee.com/markets2022) —— 66 个仓库，49 个自建原创 → [开源项目（Gitee）](gitee.md)
